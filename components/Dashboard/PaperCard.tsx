...
export const PaperCard: React.FC<PaperCardProps> = ({
  ...
  const progress = paper.chapters.length > 0
    ? Math.round((completedChapters.length / paper.chapters.length) * 100)
    : 0;
    ...
    <div className="bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden transition-all hover:shadow-lg">
        ...
        <div className="flex items-start justify-between mb-3">
          <div className="flex items-start gap-3 flex-1">
            ...
            <div className="flex-1">
              <h3 className="text-lg font-semibold text-gray-800 mb-2">{paper.name}</h3>
              <div className="flex items-center gap-4 text-sm text-gray-700">
                <span>
                  {completedChapters.length} of {paper.chapters.length} chapters completed
                </span>
      ...
      {isExpanded && (
        <div className="border-t border-gray-200 bg-gray-50 p-5">
          <h4 className="text-sm font-semibold text-gray-700 mb-3 uppercase">Chapters</h4>
